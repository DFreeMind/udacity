...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer_src="{trailer_src}" data-toggle="modal" data-target="#trailer">
    <h4>{movie_title}</h4>
    <img src="{poster_image_url}" width="220" height="342" style="float: left;">
    <div style="text-align:left;padding-left:2px;">
       <div><span style="color:blue;">Director:</span>{director}</div>
       <div><span style="color:blue;">Stars:</span>{stars}</div>
       <div><span style="color:blue;">Release Date:</span>{release_date}</div>
       <div><span style="color:blue;">Runtime:</span>{runtime}</div>
    </div>
</div>
'''
