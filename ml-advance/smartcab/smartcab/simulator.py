...
class Simulator(object):
    ...
    def __init__(self, env, size=None, update_delay=0.000001, display=False, log_metrics=True, optimized=True):
        self.env = env
    ...
    def run(self, tolerance=0.01, n_test=100):
        ...
        while True:
            ...
            # Flip testing switch
            if not testing:
                if total_trials > 3000: # Must complete minimum 20 training trials
                    if a.learning:
